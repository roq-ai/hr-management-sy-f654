  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Streamline your HR processes with HR Management System - centralizing employee data, vacations, time tracking, payrolls, and performance evaluations in one powerful platform."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Streamline your HR processes with HR Management System - centralizing employee data, vacations, time tracking, payrolls, and performance evaluations in one powerful platform.`}
            </Text>
            <Box
